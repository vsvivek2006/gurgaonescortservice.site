...
import { BookOpen, Home, Phone, MessageCircle } from 'lucide-react';
    ...
    <section className="min-h-[75vh] flex items-center justify-center bg-[#FFFDF6] py-20 px-4 text-[#2d2d2d]">
      <div className="max-w-2xl w-full text-center">
        ...
        <p className="text-gray-600 text-sm md:text-base mb-8 max-w-lg mx-auto leading-relaxed">
          The guide or article you are looking for may have been updated, moved, or is currently being refreshed by our editorial desk.
        </p>
